...
# python test_personalization.py --num_agents 10 --personalization 'variance' --load_agents 'agents-clustered' --seed 42 --specific_agents 'PersonalAgent-2' --model 'Reinforce' --inner_updates 10 --log_interval 1 --episode_len 1000 --num_episodes 1000 --save_results './results/results-r-1.csv' --save_model './trained_models/model-r-1.pt' --trained_model 'model_ppe_simple_reinforce_2-2.pt'

# python meta_evaluate.py --num_agents 1 --personalization 'cluster' --load_agents 'agents-clustered-p' --seed 42 --model 'Reinforce' --inner_updates 10 --log_interval 1 --episode_len 100 --num_episodes 50 --save_results './results/results-r-1.csv' --save_model './trained_models/model-r-1.pt' --trained_model 'model_ppe_simple_reinforce_2-2.pt'
